...
## [1.0.0-rc.3] - 2025-04-26

### Added

- About section with some extra information

### Changed

- Updated dependencies

## [1.0.0-rc.2] - 2025-04-17

### Changed

- The suggested filename for video downloads now includes the video id

### Fixed

- Fix typos

## [1.0.0-rc.1] - 2025-04-16

### Added

- Button for changing the app language
- Donation addresses
- Trying to update YoutubeDL or watching a video will now warn you if your connection is metered
- Settings for turning metered connection warnings on or off
